...
const Footer = () => {
  return (
    <footer className="bg-pitch-blue text-white">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-300">
              Book your perfect sports venue with ease. Find and reserve the best sports grounds in your city.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/grounds" className="text-gray-300 hover:text-white transition-colors">Grounds</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              ...
              <p>New Delhi, India</p>
              <p className="mt-3">Email: info@pitchperfect.com</p>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <img src="https://via.placeholder.com/200x30?text=Payment+Methods" alt="Payment Methods" className="h-8" />
          </div>
        </div>
      </div>
    </footer>
